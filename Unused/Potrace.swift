...
final class Potrace {
    ...
    func getBezierPath(scale size: Double = 1.0) -> NSBezierPath {
        ...
        func path(curve: Curve, bezierPath: NSBezierPath) {
            ...
            func bezier(i: Int) {
                bezierPath.curve(to: CGPoint(x: (curve.c[i * 3 + 2].x * size), y: (curve.c[i * 3 + 2].y * size)),
            ...
            func segment(i: Int) {
                bezierPath.line(to: CGPoint(x: (curve.c[i * 3 + 1].x * size), y: (curve.c[i * 3 + 1].y * size)))
                bezierPath.line(to: CGPoint(x: (curve.c[i * 3 + 2].x * size), y: (curve.c[i * 3 + 2].y * size)))
            }
        ...
        bezierPath.windingRule = NSBezierPath.WindingRule.evenOdd;
