...
/** Computes shortest distance from a point to a cubic bezier curve
 @param point The lone point
 @param curve Array of control points of a cubic bezier curve. Must contain 4 points.
...
/** Calculates the point on a cubic bezier curve for the given t value.
 ...
 @param points Control points of the bezier curve. Must contain 4 values.
 */
...
/** Calculates the point on a quadratic bezier curve for the given t value.
 @param t Parametric curve value between 0 and 1.
 @param points Control points of the bezier curve. Must contain 3 values.
 */
...
/** Determines if two line segments intersect and returns the parametric value along each line where the intersect occurrs.
 @param pt1 First point on first line segment
 @param pt2 Second point on first line segment
 @param pt3 First point on second line segment
 @param pt4 Second point on second line segment
...
/** Determines if a set of set of two test vectors overlaps another set of two test vectors.
...
/** Determines if a polygon corner is crossed by a corner formed by another polygon
 @param v1 polygon corner
 @param v2 polygon corner
 @param v3 polygon corner
 @param v4 polygon corner
